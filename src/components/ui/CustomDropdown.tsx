  ...
  return (
    <div ref={ref} className="relative w-full select-none">
      ...
      <button
        ...
        bg-[#282828] text-left border-[#434343]
        ${open ? "rounded-b-none" : "hover:border-[#434343]"}
      ...
      {/* Menu */}
      {open && (
        <div className="absolute left-0 right-0 top-full z-50 bg-[#282828] border border-t-0 border-[#434343] rounded-b-md overflow-hidden">
          {options.map((opt) => (
            <button
              key={opt.value}
              type="button"
            ...
            >
              ...
              {opt.meta && (
                <span className="ml-auto text-xs text-[#A6A6A6]">
                  {opt.meta}
                </span>
              )}
            </button>
